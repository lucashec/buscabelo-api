...
export class DatabaseStart1623360759744 implements MigrationInterface {
    name = 'DatabaseStart1623360759744'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "appointment" ("id" SERIAL NOT NULL, "scheduled_at" TIMESTAMP NOT NULL, "appointment_to" TIMESTAMP NOT NULL, "time_done_at" TIMESTAMP NOT NULL, "canceled_at" TIMESTAMP NOT NULL, "providerId" uuid, "customerId" uuid, CONSTRAINT "REL_f013bda65c235464178ac02592" UNIQUE ("providerId"), CONSTRAINT "REL_c048c6004b69354f46183f93a8" UNIQUE ("customerId"), CONSTRAINT "PK_e8be1a53027415e709ce8a2db74" PRIMARY KEY ("id"))`);
