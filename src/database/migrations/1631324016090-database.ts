...
export class database1631324016090 implements MigrationInterface {
    name = 'database1631324016090'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "rating" ("id" SERIAL NOT NULL, "description" character varying, "rating_number" integer NOT NULL, "appointmentId" integer, CONSTRAINT "PK_ecda8ad32645327e4765b43649e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "appointment" ("id" SERIAL NOT NULL, "scheduled_at" TIMESTAMP NOT NULL, "appointment_to" TIMESTAMP NOT NULL, "time_done_at" TIMESTAMP, "canceled_at" TIMESTAMP, "providerId" uuid, "customerId" uuid, "serviceId" integer, CONSTRAINT "PK_e8be1a53027415e709ce8a2db74" PRIMARY KEY ("id"))`);
